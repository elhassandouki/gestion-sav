...
<li><a href="utilisateursavAD.php" ><center><img src="img/1451156880_about_us.png" width="30" height="30" style="margin-top:-15px;"/><h6>Utilisateur</h6></center></a></li>
...
<li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="technicienAD.php">Technicien</a></li> 

           <li><a href="enlAD.php">en ligne ??</a></li>

         <li><a href="MsgAD.php">Message</a></li>
